...
class _$MovieDetailImpl implements _MovieDetail {
  ...
  @override
  String toString() {
    return 'MovieDetail(id: $id, title: $title, overview: $overview, posterPath: $posterPath, backdropPath: $backdropPath, voteAverage: $voteAverage, runtime: $runtime, genres: $genres)';
  }
