...
import 'package:flutter_application_1/domain/usecases/create_transaction/create_transaction.dart';
import 'package:flutter_application_1/domain/usecases/create_transaction/create_transaction_param.dart';
import 'package:flutter_application_1/domain/usecases/top_up/top_up_param.dart';
...
class TopUp implements UseCase<Result<void>, TopUpParam> {
  ...
  Future<Result<void>> call(TopUpParam params) async {
    ...
    var createTransactionResult = await createTransaction(CreateTransactionParam(transaction: Transaction(
