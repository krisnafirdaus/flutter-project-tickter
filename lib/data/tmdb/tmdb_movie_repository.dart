...
class TmdbMovieRepository implements MovieRepository{
  final Dio? _dio;
  final String _accessToken = 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlMDU5MjI2NGEzYWEzZGE1MjMwMzBjY2NlMDMyNTI4OSIsInN1YiI6IjY1YjUzMDBlNGYzM2FkMDE0NzBiMmZiYSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.u8iwQa8slyewfRtg6TwOXjjZAsvukXN8WM0oZQjZXNk';
  ...
  @override
  Future<Result<List<Movie>>> getNowPlaying({int page = 1}) async => _getMovies(_MovieCategory.nowPlaying.toString(), page: page);

  @override
  Future<Result<List<Movie>>> getUpcoming({int page = 1}) async => _getMovies(_MovieCategory.upcoming.toString(), page: page);
